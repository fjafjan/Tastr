...
function HighMmrFunction(
  ...
  const high_rank_score = (normalized_mmrs[foodIdA] + normalized_mmrs[foodIdB]) / 2
...
export {
  GenerateSelections,
  GetSelection, HasTastedFunction, HighMmrFunction, SelectionScore, SimilarMmrFunction, type FoodObject
};
