...
import { HasTastedFunction, HighMmrFunction, SimilarMmrFunction } from "../../backend/core/selection";
...
describe("SelectionTests", () => {
  ...
  test("Check similar MMR function", async () => {
    ...
    const somewhat_fair_mmr_score = SimilarMmrFunction("food-a", "food-c", mmrs)
